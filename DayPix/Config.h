...
const int B_16BIT_EEPROM_ADDR = DMX_ADDR_EEPROM_ADDR + 1;
const int DEV_NAME_EEPROM_ADDR = B_16BIT_EEPROM_ADDR + 32;
const int WIFI_ATTEMPT = DEV_NAME_EEPROM_ADDR + 64;
const int B_FAILOVER_EEPROM_ADDR = WIFI_ATTEMPT + 1;
const int B_SILENT_EEPROM_ADDR = B_FAILOVER_EEPROM_ADDR + 1;
const int B_REVERSE_ARRAY_EEPROM_ADDR = B_SILENT_EEPROM_ADDR + 1;

const int B_DHCP_EEPROM_ADDR = B_REVERSE_ARRAY_EEPROM_ADDR + 1;
const int IP_ADDR_EEPROM_ADDR = B_DHCP_EEPROM_ADDR + 1;
